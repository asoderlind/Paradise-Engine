...
void main() {
    ...
    //float height = heightMapVec.r * heightMapScale + heightMapBias;//(heightMapVec.r + heightMapVec.g + heightMapVec.b) * heightMapScale + heightMapBias;//* 150.f - 18.f;
    // vHeight = height;
    ...
    windLeanAngle = easeIn(windLeanAngle, 2.0) * 1.25 * heightPercent;
